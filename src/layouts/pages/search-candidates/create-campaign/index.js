...
import { createSMSCampaign } from "../../../../firebase/backend/sms-campaign";
...
export default function CreateCampaign({ isOpenModal, handleCloseModal, candidateCount, filters }) {
  ...
  const createCampaign = useCallback(async () => {
    try {
      await createSMSCampaign({
        ...
        filters: {
          role: filters.role ? filters.role : filters.constructionRole,
          area_of_expertise: filters.establishmentType
            ? filters.establishmentType
            : filters.constructionCardType,
          years_of_experience: filters.yearsOfExperience,
          ...(filters.postalCode ? { postcode: filters.postalCode } : {}),
  ...
  }, [newMailText, formData.candidateNumber, filters]);
  ...
  const handleChangeMailText = useCallback((e) => {
          ...
          {!success && !error && (
            <Grid container direction="column" gap={3}>
              ...
              <Grid item>
                ...
                >
                  <span style={{ color: "#07A0C3" }}>{candidateCount} </span>
                  Candidates Matched
                </MDTypography>
              </Grid>
              <Grid item>
...
CreateCampaign.propTypes = {
  ...
  filters: PropTypes.shape({
    ...
    constructionRole: PropTypes.string,
    constructionCardType: PropTypes.string,
